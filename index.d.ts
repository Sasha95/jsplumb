declare module jsPlumb {
  ...
  class jsPlumbInstance {
    addEndpoint(
      el: ElementGroupRef,
      params?: EndpointOptions,
      referenceParams?: EndpointOptions
    ): Endpoint | Array<Endpoint>;

    addEndpoints(
      target: ElementGroupRef,
      endpoints: Array<EndpointOptions>,
      referenceParams?: EndpointOptions
    ): Array<Endpoint>;
  ...
  type EndpointDotOptions = {
    radius?: number;
    cssClass?: string;
    hoverClass?: string;
  };
  type EndpointRectangleOptions = {
    width?: number;
    height?: number;
    cssClass?: string;
    hoverClass?: string;
  };
  type EndpointImageOptions = {
    src: string;
    cssClass?: string;
    hoverClass?: string;
  };
  ...
  type AnchorPerimeterSpec =
    | AnchorPerimeterId
    | [
        AnchorPerimeterId,
        { shape?: PerimeterShape; anchorCount?: number; rotation?: number }
      ];
  ...
  type AnchorContinuousSpec =
    | AnchorContinuousId
    | [AnchorContinuousId, { faces?: [ContinuousAnchorFace] }];
